...
const SiteOverviewCard = () => {
  ...
  return (
    <section className="my-14 font-roboto">
      <div className="container mx-auto">
        <div className="shadow-sm rounded-xl overflow-hidden">
          {/* Header Section */}
          <div className="bg-gradient-to-r from-[#7B5AFF] to-[#8C52FF] p-8">
            <h1 className="text-white text-3xl font-playfair leading-snug">
