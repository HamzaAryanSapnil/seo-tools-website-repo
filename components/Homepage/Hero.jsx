...
export default function HeroSection() {
  return (
    <section
      style={{
        backgroundImage: "linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)),url('./seo-studio-banner.jpeg')",
        backgroundRepeat: "no-repeat",
        backgroundSize: "cover",
      }}
      className=" bg-gradient-to-b from-blue-50 to-white py-20 min-h-[90vh] flex justify-center items-center text-white font-roboto"
    >
